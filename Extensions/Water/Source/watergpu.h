...
#ifndef _Horde3DWater_watergpu_H_
#define _Horde3DWater_watergpu_H_

#include "water.h"

namespace Horde3DWater
{
	extern const char *vsWaterGPUDebugView;
	extern const char *fsWaterGPUDebugView;

	class WaterNodeGPU : public WaterNode
	{
	protected:
		// Geometry data
	...
	public:
		...
		WaterNodeGPU( const WaterNodeTpl &waterTpl );
		~WaterNodeGPU();
